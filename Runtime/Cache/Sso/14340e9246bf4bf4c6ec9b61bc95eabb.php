			...
			layui.use(['layer'], function() {
				var layer = layui.layer,
					...
					$('.login').click(function(){
						...
						// 跨域   单点登录start
						var setSSOkeyUrl = "<?php echo C('http_origins')[2];?>/Api/UserCenter/index";
						$.ajax({
							type: 'POST',
						    crossDomain: true,
			                xhrFields: {
							...
							url: setSSOkeyUrl,
						    data: {user_name:name,password:pwd},
						    dataType: "json",
						    complete: function(){
								var ssoUrl = "<?php echo U('Login/doLogin');?>";
